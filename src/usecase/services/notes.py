...
class NotesService:
    async def add_note(self, uow: IUnitOfWork, note: NoteSchemaAdd, organization_id: int):
    ...
    async def get_notes(self, uow: IUnitOfWork, start_date: datetime = None, end_date: datetime = None):
        async with uow:
